...
public class HelloWorldApplication {
	public static void main(String[] args) {
		 ...
		 * Class를 통한 빈 생성/등록/와이어링 작업 4. 만약 웹애플리션이고 타입이 Spring MVC 이면 - 내장(embeded)
		 * 서버(TomcatEmbededServiceServletContainer) 인스턴스 생성 - 서버 인스턴스에 웹 애플리케이션 배포 - 서버
